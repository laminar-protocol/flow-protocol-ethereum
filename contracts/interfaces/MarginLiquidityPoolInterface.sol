...
interface MarginLiquidityPoolInterface is LiquidityPoolInterface {
    ...
    function enableToken(address baseToken,address quoteToken,uint256 spread,int256 _newSwapRateMarkup) external;
    ...
    function setCurrentSwapRateMarkupForPair(address base, address quote, int256 newSwapRateMarkup) external;
